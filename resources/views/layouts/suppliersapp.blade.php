...
<div class="main-header">
    ...
    <div class="header-right">
        ...
        <!-- MENU -->
        <div class="top-menu">
            <a href="{{ route('supplierdashboard') }}" class="{{ request()->is('supplierdashboard') ? 'active' : '' }}">Dashboard</a>
        ...
        <div class="top-menu">
            <a href="{{ route('productenquiry') }}" class="{{ request()->is('productenquiry') ? 'active' : '' }}">Products Enquiry</a>

                    ...
                    <!-- <div class="mb-4">
                        ...
                        <div id="categoryFilters">
                            <label class="filter-category-item d-flex align-items-center gap-3">
                                <input type="checkbox" class="form-check-input m-0 category-check" value="Construction">
                                <span class="fs-5">🏗️</span>
                                <div class="flex-grow-1">
                                    <span class="fw-semibold">Construction</span>
                                    <small class="text-muted ms-1">(234)</small>
                                </div>
                            </label>
                            <label class="filter-category-item d-flex align-items-center gap-3">
                                <input type="checkbox" class="form-check-input m-0 category-check" value="Electrical">
                                <span class="fs-5">⚡</span>
                                <div class="flex-grow-1">
                                    <span class="fw-semibold">Electrical</span>
                                    <small class="text-muted ms-1">(189)</small>
                                </div>
                            </label>
                            <label class="filter-category-item d-flex align-items-center gap-3">
                                <input type="checkbox" class="form-check-input m-0 category-check" value="Plumbing">
                                <span class="fs-5">🔧</span>
                                <div class="flex-grow-1">
                                    <span class="fw-semibold">Plumbing</span>
                                    <small class="text-muted ms-1">(156)</small>
                                </div>
                            </label>
                            <label class="filter-category-item d-flex align-items-center gap-3">
                                <input type="checkbox" class="form-check-input m-0 category-check" value="Interior Design">
                                <span class="fs-5">🎨</span>
                                <div class="flex-grow-1">
                                    <span class="fw-semibold">Interior Design</span>
                                    <small class="text-muted ms-1">(178)</small>
                                </div>
                            </label>
                            <label class="filter-category-item d-flex align-items-center gap-3">
                                <input type="checkbox" class="form-check-input m-0 category-check" value="Carpentry">
                                <span class="fs-5">🪚</span>
                                <div class="flex-grow-1">
                                    <span class="fw-semibold">Carpentry</span>
                                    <small class="text-muted ms-1">(145)</small>
                                </div>
                            </label>
                            <label class="filter-category-item d-flex align-items-center gap-3">
                                <input type="checkbox" class="form-check-input m-0 category-check" value="Painting">
                                <span class="fs-5">🎨</span>
                                <div class="flex-grow-1">
                                    <span class="fw-semibold">Painting</span>
                                    <small class="text-muted ms-1">(167)</small>
                                </div>
                            </label>
                        </div>
                    </div> -->
            ...
            <div class="col-lg-9">
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="fw-bold mb-1"><span id="vendorCount">{{ $vendor_reg->count() }}</span> Professional Vendors</h3>
                ...
                <!-- VENDOR CARDS -->
                 @foreach($vendor_reg as $vendor)
                    <div id="vendorList">
                        ...
                        <!-- Vendor Card 1 -->
                        <div class="vendor-card" data-category="Construction" data-rating="4.8" data-state="Maharashtra">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <h3 class="vendor-name">{{ strtoupper($vendor->name)}}</h3>
                                    <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
                                        <span class="category-badge">{{ $vendor->work_type }}</span>
                                        <span class="text-muted">•</span>
                                        <div class="d-flex align-items-center gap-1">
                                            <i class="bi bi-briefcase-fill text-primary"></i>
                                            <span class="fw-semibold small">{{ $vendor->business_name }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center gap-3 mb-2">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span class="fw-semibold small">12+ years</span>
                                        </div>
                                    ...
                                    <div class="row align-items-center mt-3">
                                        ...
                                        <!-- RIGHT : ACTION BUTTON (50%) -->
                                        <div class="col-md-5 d-flex justify-content-end align-items-center mt-3 mt-md-0">

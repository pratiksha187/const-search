...
.auto-scroll{
  animation: scrollBrands 90s linear infinite; /* slower */
}
...
.brand-scroll-wrapper:hover .auto-scroll{
...
<div class="supplier-search-page">
  ...
  <div class="search-header">
    <div>
      <h4>Suppliers/Manufacturer/Automation</h4>
...
if(brandScroll && wrapper){
  const scrollWidth = brandScroll.scrollWidth / 2; // half content duplicated
  const wrapperWidth = wrapper.offsetWidth;
  
  // Duration in seconds: bigger content = longer duration
  const speed = 20; // pixels per second
  const duration = scrollWidth / speed; // in seconds

  brandScroll.style.animation = `scrollBrands ${duration}s linear infinite`;
}

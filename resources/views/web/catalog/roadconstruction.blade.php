...
@csrf
<input type="hidden" name="material_category_id" value="5">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <select class="form-select js-product-type" name="product_type">
                ...
                @foreach($roadconstruction as $roadconstructions)
                    <option value="{{ $roadconstructions->id }}">{{ $roadconstructions->product_name }}</option>
                @endforeach
            </select>
        </div>

...
<input type="hidden" name="material_category_id" value="6">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select class="form-select js-product-type" name="product_type">
                    ...
                    @foreach($Plumbingmaterials as $Plumbingmaterial)
                    <option value="{{ $Plumbingmaterial->id }}">{{ $Plumbingmaterial->product_name }}</option>
                    @endforeach
                </select>
            </div>
